// Student ID:S0143046 Name:吳詮義Date:2016/3/23 Major:地理系
...
function init() {
    ...
    var gui = new dat.GUI();
    gui.add(this, 'flight_point_speed_scaling', flight_point_speed_min_scaling, flight_point_speed_max_scaling).name("速度").onFinishChange(function(value) {
        flight_point_speed_changed = true;
        update_flights();
        flight_point_speed_changed = false;
    });
    gui.add(this, 'flight_point_size', 0.01, 0.2).name("大小").onChange(function(value) {
    ...
    gui.add(this, 'flight_track_opacity', 0, 1.0).name("航線透明度").onChange(function(value) {
